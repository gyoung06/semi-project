...
“주식회사 가내스라”는 회원가입, 상품주문, 대금결제, 배송 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.


*필수정보


이름, 아이디, 비밀번호, 휴대전화번호, 이메일주소
...
단,「전자상거래 등에서의 소비자보호에 관한 법률」 등 관련법령의 규정에 의하여


다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 그 기간 동안 보유합니다.
...
o 위탁 대상자 : (주)케이지이니시스, (주)케이지모빌리언스
o 위탁업무 내용 : 전자지급결제대행서비스

o 위탁 대상자 : 스냅컴퍼니
o 위탁업무 내용 : 고객 개인 정보(이름, 전화번호)를 이용한 이벤트 전달
