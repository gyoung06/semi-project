...
COMMENT ON COLUMN FAQ.FPUBLIC_PRIVATE IS '0. 공개
1. 비공개';
COMMENT ON COLUMN GRADE.GLEVEL IS '0.실버 등등';
...
COMMENT ON COLUMN NOTICE.FPUBLIC_PRIVATE IS '0. 공개
1. 비공개';
COMMENT ON COLUMN ORDERS.ORDATE IS 'SYSDATE';
COMMENT ON COLUMN ORDERS.ORPAYMENT IS '1.현금입금 2.카드 3.카카오페이 등';
COMMENT ON COLUMN ORDERS.ORDELPAY IS '0.무료 1.일반 2.특수';
COMMENT ON COLUMN ORDER_DETAIL.ODCOUPON IS '전체가격쿠폰';
...
COMMENT ON COLUMN USERQNA.QCATE IS '1.상품 2.교환/환불 3.사이트이용 4.기타';
COMMENT ON COLUMN USERQNA.QRDATE IS 'DATE DEFAULT SYSDATE';
COMMENT ON COLUMN USERQNA.QLEV IS '0.미처리 1.처리';
